...
class Metaclass_SellNovel_Event(type):
    """Metaclass of message 'SellNovel_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__sell_novel__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__sell_novel__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__sell_novel__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__sell_novel__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__sell_novel__event
...
class SellNovel_Event(metaclass=Metaclass_SellNovel_Event):
    """Message class 'SellNovel_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<village_interfaces/SellNovel_Request, 1>',
        'response': 'sequence<village_interfaces/SellNovel_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['village_interfaces', 'srv'], 'SellNovel_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['village_interfaces', 'srv'], 'SellNovel_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from village_interfaces.srv import SellNovel_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SellNovel_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SellNovel_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from village_interfaces.srv import SellNovel_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SellNovel_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SellNovel_Response'"
...
class Metaclass_SellNovel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _sell_novel.Metaclass_SellNovel_Event._TYPE_SUPPORT is None:
                _sell_novel.Metaclass_SellNovel_Event.__import_type_support__()
...
class SellNovel(metaclass=Metaclass_SellNovel):
    ...
    from village_interfaces.srv._sell_novel import SellNovel_Event as Event
