  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb5, 0x01, 0x55, 0x20, 0xda, 0x65, 0x77, 0x38,
      0xf7, 0x7c, 0x60, 0xb5, 0x76, 0x27, 0xc1, 0xae,
      0x27, 0xc2, 0x29, 0x2c, 0x58, 0x4e, 0xb7, 0xde,
      0xae, 0x90, 0x58, 0x14, 0x06, 0x19, 0x96, 0xb7,
    }};
  return &hash;
}
...
static char village_interfaces__msg__Novel__TYPE_NAME[] = "village_interfaces/msg/Novel";
static char builtin_interfaces__msg__Time__TYPE_NAME[] = "builtin_interfaces/msg/Time";
static char sensor_msgs__msg__Image__TYPE_NAME[] = "sensor_msgs/msg/Image";
static char std_msgs__msg__Header__TYPE_NAME[] = "std_msgs/msg/Header";

// Define type names, field names, and default values
static char village_interfaces__msg__Novel__FIELD_NAME__content[] = "content";
static char village_interfaces__msg__Novel__FIELD_NAME__image[] = "image";

static rosidl_runtime_c__type_description__Field village_interfaces__msg__Novel__FIELDS[] = {
  {
    {village_interfaces__msg__Novel__FIELD_NAME__content, 7, 7},
    {
  ...
  {
    {village_interfaces__msg__Novel__FIELD_NAME__image, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription village_interfaces__msg__Novel__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {village_interfaces__msg__Novel__TYPE_NAME, 28, 28},
      {village_interfaces__msg__Novel__FIELDS, 2, 2},
    },
    {village_interfaces__msg__Novel__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *village_interfaces__msg__Novel__get_individual_type_description_source(NULL),
