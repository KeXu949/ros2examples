...
class Metaclass_BorrowMoney_Event(type):
    """Metaclass of message 'BorrowMoney_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__borrow_money__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__borrow_money__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__borrow_money__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__borrow_money__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__borrow_money__event
...
class BorrowMoney_Event(metaclass=Metaclass_BorrowMoney_Event):
    """Message class 'BorrowMoney_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<village_interfaces/BorrowMoney_Request, 1>',
        'response': 'sequence<village_interfaces/BorrowMoney_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['village_interfaces', 'srv'], 'BorrowMoney_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['village_interfaces', 'srv'], 'BorrowMoney_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from village_interfaces.srv import BorrowMoney_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, BorrowMoney_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'BorrowMoney_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from village_interfaces.srv import BorrowMoney_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, BorrowMoney_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'BorrowMoney_Response'"
...
class Metaclass_BorrowMoney(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _borrow_money.Metaclass_BorrowMoney_Event._TYPE_SUPPORT is None:
                _borrow_money.Metaclass_BorrowMoney_Event.__import_type_support__()
...
class BorrowMoney(metaclass=Metaclass_BorrowMoney):
    ...
    from village_interfaces.srv._borrow_money import BorrowMoney_Event as Event
